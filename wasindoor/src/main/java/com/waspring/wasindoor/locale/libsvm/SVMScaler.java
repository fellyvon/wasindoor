...
public class SVMScaler
{
	...
	public SVMScaler(String str1)
	{
		outputFileAddr = str1;
		try {
			fileWriter = new FileWriter(outputFileAddr);
		} catch (IOException e) {			
			e.printStackTrace();
			System.out.println("��ݱ�׼���У���ʼ��fileWriter���?����");
		}
	}

	private static void exit_with_help()
	{
		String str1 =  "Usage: svm-scale [options] data_filename\n"
			+"options:\n"
...
//		System.out.print(value + " ");
		try {
			...
			e.printStackTrace();
			System.out.println("��ݱ�׼���У�fileWriterд�ļ����?����");
		}
	}
...
//			System.out.print(index + ":" + value + " ");
	...
	//���ڵ�����¼�ı�׼����Ŀ���ǩ
	private Integer scale_target_entity(double value)
	{
		if(y_scaling)
		{
			if(value == y_min)
...
//		System.out.print(value + " ");
	...
	//���ڵ�����¼�ı�׼����һ�����Ժ����Ӧֵ 
	private double scale_entity(int index, double value)
	{
		/* skip single-valued attribute */
		if(feature_max[index] == feature_min[index])
			return 0;
...
//			System.out.print(index + ":" + value + " ");			
	...
	public void scaleIntoFile(String []argv) throws IOException
	{
		int i,index;
		...
		while(readline(fp) != null)
		{
			...
			while(st.hasMoreElements())
			{
				index = Integer.parseInt(st.nextToken());
				value = Double.parseDouble(st.nextToken());
				for (i = next_index; i<index; i++) //1:0.33 3��0.66�����м�û��2��XX�ģ���Ĭ�����2:0 
					output(i, 0);
				output(index, value);
				next_index = index + 1;
			}
...
//			System.out.print("\n");
	...
	//��һ����¼�е�x,y,z��ݱ�׼��
	public GeomagneticEntity scale(GeomagneticEntity entity, String scaleFileAddr)
	{
		int i;
		BufferedReader fp_restore = null;		
		String restore_filename = null;
		
		restore_filename = scaleFileAddr + File.separator + entity.getBuildingId() + File.separator
		...
		if(true)
		{
			...
			try {
				...
				System.err.println("û�н��б�׼���������ļ���ģ���ļ�������ѵ�������׼��ģ���ļ�!�ļ�·��:" + restore_filename);
				return null;
			}
		...
		/* pass 3: scale */		
		double xMag = entity.getxMagnetic();
		double yMag = entity.getyMagnetic();
		double zMag = entity.getzMagnetic();
		
		xMag = scale_entity(1, xMag);
		yMag = scale_entity(2, yMag);
		zMag = scale_entity(3, zMag);
	...
	//��һ����¼�е�x,y,z��ݱ�׼��. ǰ�᣺����entities�е���Ŀ����ͬһ��������ͬһ��
	public Vector<GeomagneticEntity> scale(Vector<GeomagneticEntity> entities, 
			String scaleFileAddr) throws Exception
	{
		int i;
		BufferedReader fp_restore = null;		
		String restore_filename = null;
		
		restore_filename = scaleFileAddr + File.separator + entities.get(0).getBuildingId() + File.separator + entities.get(0).getFloor() + File.separator+"train_scale_model";
		...
		if(true)
		{
			...
			try {
				...
				throw new Exception("û�н��б�׼���������ļ���ģ���ļ�������ѵ�������׼��ģ���ļ�!�ļ�·��:" + restore_filename);
		...
		for(int j=0;j<entities.size();j++){
			GeomagneticEntity entity = entities.get(j);
			double xMag = entity.getxMagnetic();
			double yMag = entity.getyMagnetic();
			double zMag = entity.getzMagnetic();
			...
			entities.get(j).setxMagnetic(xMag);
			entities.get(j).setyMagnetic(yMag);
			entities.get(j).setzMagnetic(zMag);
		}
	...
	public static void main(String argv[]) throws IOException
	{
		...
		/*
		GeomagneticEntity entity = new GeomagneticEntity(1,1,0,0,-160,-25.146,-32.78999999999999,
				9.948000000000002,"2014/7/5 10:32:06",2);
		s.scale(entity, "E:\\indoorGeo\\gmLocatorModel\\");	*/
